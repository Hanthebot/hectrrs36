...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LGUI, LT(1, KC_TAB), LSFT_T(KC_SPC), LALT_T(KC_ENT), LCTL_T(KC_ENT), LT(2, KC_BSPC)
    ),
    [1] = LAYOUT(
        ...
        KC_TRNS, KC_NO, KC_TRNS, KC_BSPC, KC_ENT, KC_RALT
    ),
    [2] = LAYOUT(
        ...
        KC_LCTL, LSFT_T(KC_0), KC_0, KC_NO, KC_LSFT, KC_TRNS
    ),
    [3] = LAYOUT(
        ...
        KC_BTN3, KC_BTN1, KC_BTN2, KC_NO, KC_LCTL, KC_TRNS
    ),
    [4] = LAYOUT(
        ...
        KC_LSFT, KC_NO, KC_LSFT, LSFT_T(KC_0), LCTL_T(KC_0), KC_TRNS
    ),
    [5] = LAYOUT(
        ...
        KC_ESCAPE, KC_SPC, KC_LSFT, KC_RSFT, KC_ENT, KC_BSPC
    ),
};
